...
// Таке обгортання виразу символами / є стандартною практикою у багатьох мовах програмування, включаючи JavaScript, для позначення початку і кінця регулярного виразу.
// Воно робить вираз більш зрозумілим і простим у сприйнятті, а також дозволяє легко розрізняти вирази від інших частин коду.
// символи / використовуються для обгортання регулярного виразу у JavaScript, вказуючи його початок і кінець.
