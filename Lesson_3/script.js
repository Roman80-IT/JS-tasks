...
//! =============================================
//?         «через крапку»    -      user.location.country:   -   «крапка» вказує наступну вкладеніст
//*               const user = {
//*                 name: "Jacques Gluke",
//*                 tag: "jgluke",
//*                 location: {
...
//*           Далі отримуємо доступ до його елементів через квадратні дужки та індекс або використовувати властивості і методи.
